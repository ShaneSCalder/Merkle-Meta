...
Certainly! Let's update the `README.md` file for the `Merkle-Proof` project to include a section that provides information about the npm package.
...
```sh
npm install @shanescalder/merkleproof
```
...
1. Open your `README.md` file for `Merkle-Proof`.
